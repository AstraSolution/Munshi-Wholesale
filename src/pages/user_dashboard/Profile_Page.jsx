            ...
            <div className="mt-1 lg:mt-3 lg:min-h-screen bg-gray-800 shadow-xl rounded-lg text-gray-300 ">
              ...
              <div className="mx-auto w-32 h-32 relative -mt-16 border-4 border-white rounded-full overflow-hidden">
                <img
                  ...
                  src="https://i.ibb.co/5jQYxLn/about1.jpg"
              ...
              <div className="text-center mt-2 text-gray-200 ">
                ...
                {isEditing ? (
                  <div className="mb-2 mt-8 px-4 ">
                    ...
                    <select className="w-full px-4 py-3 border-gray-600 text-gray-300 border rounded-md bg-[#1A222C]  focus:outline-none focus:border-blue-500">
                      <option value="">profession</option>
                      <option value="student">Student</option>
                      <option value="business">Business</option>
                      <option className="pb-2" value="doctore">
                        Doctor
                      </option>
                      <option className="pb-2" value="teacher">
                        Teacher
                      </option>
                      <option className="pb-2" value="socialWorker">
                        Social Worker
                      </option>
                      <option className="pb-2" value="mechanicalEngineer">
                        Mechanical Engineer
                      </option>
                    </select>
                  </div>
              ...
              <div className="px-4 py-2">
                ...
                {isEditing ? (
                  ...
                  <p className="text-sm md:text-lg lg:text-lg text-gray-200">
                    I am Siyam Ahmed. A problem solver who demonstrates skills
                    like critical thinking, analytical reasoning, creativity,
                    and persistence. They excel at identifying, analyzing, and
                    solving complex problems using systematic approaches. This
                    involves breaking down problems, generating solutions,
                    evaluating alternatives, and implementing effective
                    strategies. Effective communication and collaboration skills
                    are also crucial for working in teams and conveying
                    solutions clearly
                  </p>
                )}
              </div>
            ...
            <div>
              ...
              <div className="my-2">
                <div>
                  {isEditing ? (
                    ...
                    <div>
                      ...
                      <h3 className="border border-gray-600 rounded-md w-full py-1 px-2">
                        Full Name
                      </h3>
                    </div>
                  )}
                ...
                <div className="p-4  mx-8 mt-2">
                  {isEditing ? (
                    <button className="w-1/2 block mx-auto rounded-full bg-[#1A222C] hover:shadow-lg font-semibold text-gray-300 px-6 py-2">
                      Save Now{" "}
                    </button>
                  ) : (
                    ""
