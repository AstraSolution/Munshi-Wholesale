...
const Profile_Page = () => {
  ...
  const { _id, fullName, email, state, date_of_birth, phone_number, coverPhoto, profilePhoto, country, postCode, district, gender, bio, profession } = currentUser || {}
  ...
  const onSubmit = async (data) => {
    ...
    const { birthday, phoneNumber, country, state, postCode, fullName, district, gender, bio, profession } = data || {};
    ...
    await axiosPublic.patch(`/users/${currentUser._id}`, updateUser)
      .then((res) => {
  ...
  return (
    <>
      ...
      <div className='text-right px-4 '>
        <button onClick={toggleEditing}><CiEdit className='lg:text-3xl text-gray-900 md:text-2xl text-2xl  cursor-pointer  block  ' />
        </button>
      </div>
      {/* Profile */}
            ...
            <div className="mt-1 lg:mt-3 lg:min-h-screen bg-gray-100 shadow-xl rounded-lg text-gray-800 ">
              ...
              <div className="relative rounded-t-lg lg:h-48 md:h-40 h-32 overflow-hidden">
                {isEditing ? (
                  <>
                    {coverPreview ? (
                      <img className="object-cover object-top w-full" src={coverPreview} alt="" />
                    ) : (
                      <div className="">
                        <img className='object-cover object-top w-full' src={coverPhoto ? coverPhoto : "https://images.unsplash.com/photo-1549880338-65ddcdfd017b?ixlib=rb-1.2.1&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=400&fit=max&ixid=eyJhcHBfaWQiOjE0NTg5fQ"} alt="" />
              ...
              <div className="mx-auto w-32 h-32 relative -mt-16 border-4 border-gray-300 rounded-full overflow-hidden">
                {isEditing ? (
                  <>
                    {profilePreview ? (
                      <img className="object-cover object-top w-full" src={profilePreview} alt="" />
                    ) : (
                      <div className="">
                        <img className='object-cover object-top w-full' src={profilePhoto ? profilePhoto : "https://i.ibb.co/9HmwSVd/avatar4.jpg"} alt="Profile" />
                      </div>
                    )}
                  </>
                ) : (
                  <img className="object-cover object-center h-32" src={profilePhoto ? profilePhoto : "https://i.ibb.co/9HmwSVd/avatar4.jpg"} alt='Woman looking front' />
                )}
                <input
                  type="file"
                  id="profileFileInput"
                ...
                {/* professioon */}
                {
                  isEditing ? (
                    <div className="mb-2 mt-8 px-4 ">
                      <label className="block md:text-xl text-left text-gray-800  text-sm font-bold mb-2" htmlFor="title">
                        Profession
                      </label>
                      <select
                      ...
                      >
                        ...
                        <option value='Mechanical
                                                Engineer'>Mechanical Engineer</option>
            ...
            <div>
              ...
              <div className='my-2'>
                ...
                <div>
                  {
                    isEditing ? (
                      <div className="mb-4 pt-2 ">
                        <label className="block md:text-xl  text-gray-800  text-sm font-bold mb-2" htmlFor="title">
                          Full Name
                        </label>
                        <input
                          className="w-full px-4 py-3 border-gray-600 text-gray-800 border rounded-md bg-gray-100  focus:outline-none focus:border-blue-500"
                    ...
                    isEditing ? (
                      ...
                      <div>
                        ...
                        <h3 className='border border-gray-400 rounded-md w-full py-3 px-2'>
                          {phone_number ? phone_number : "01xxxxxxxxx"} </h3>
                      </div>
                    )
                  }
                </div>
                ...
                {isEditing ? (
                  <div className='my-2'>
                    ...
                    <div className="flex items-center mb-4">
                      ...
                      />
                      <label htmlFor="male" className="ms-2 text-sm font-medium text-gray-800 dark:text-gray-800">Male</label>
                    </div>
                    <div className="flex items-center">
                      <input
                        ...
                        className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                      />
                      <label htmlFor="female" className="ms-2 text-sm font-medium text-gray-800 dark:text-gray-800">Female</label>
                    </div>
                  </div>
                ) : (
                  <div>
                    <h1 className='py-2'>Gender</h1>
                    <h3 className='border border-gray-400 rounded-md w-full py-3 px-2 uppercase'>{gender ? gender : "N / A"}</h3>
                  </div>
                )}
                      ...
                      <div>
                        ...
                        <div className="relative ">
                          <div className="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                            <svg className="w-4 h-4 text-gray-800 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                              <path d="M20 4a2 2 0 0 0-2-2h-2V1a1 1 0 0 0-2 0v1h-3V1a1 1 0 0 0-2 0v1H6V1a1 1 0 0 0-2 0v1H2a2 2 0 0 0-2 2v2h20V4ZM0 18a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8H0v10Zm5-8h10a1 1 0 0 1 0 2H5a1 1 0 0 1 0-2Z" />
                            </svg>
                          </div>
                          <input defaultValue={date_of_birth} type="date" {...register("birthday")} required name="birthday" className="border-gray-600 text-gray-800 border rounded-md bg-gray-100   focus:outline-none focus:border-blue-500 text-sm  block w-full ps-10 py-3 dark:focus:border-blue-500" placeholder="Select your birthday date" />
                        </div>
                      </div>
                    ) :
                      (
                ...
                <div className="p-4  mx-8 mt-2">
                  ...
                  {isEditing ? (
                    <button type="submit" className="px-6 py-3 w-full bg-gray-900 rounded-lg font-bold text-gray-200  focus:outline-none ">
                      Save Changes
                    </button>
                  ) : (
                    ""
