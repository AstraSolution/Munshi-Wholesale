                    ...
                    <div className='lg:w-4/12 w-full '>
                        ...
                        <div className="mt-1 lg:mt-3 lg:min-h-screen bg-gray-800 shadow-xl rounded-lg text-gray-300 ">
                            ...
                            <div className='px-4 py-2'>
                                <h1 className='border-b-2 pb-1 border-gray-600 lg:mt-4'> Bio </h1>
                                {isEditing ? (
                                    <textarea
                                ...
                                {isEditing ? (
                                    <div className='my-2'>
                                        ...
                                        <div className="flex items-center mb-4">
                                            ...
                                            />
                                            <label htmlFor="male" className="ms-2 text-sm font-medium text-gray-300 dark:text-gray-300">Male</label>
                                        </div>
                                        <div className="flex items-center">
                                            <input
                                                ...
                                                className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                            />
                                            <label htmlFor="female" className="ms-2 text-sm font-medium text-gray-300 dark:text-gray-300">Female</label>
                                        </div>
                                    </div>
                                ) : (
                                    <div>
                                        <h1 className='py-2'>Gender</h1>
                                        <h3 className='border border-gray-600 rounded-md w-full py-3 px-2 uppercase'>{gender ? gender : "N / A"}</h3>
                                    </div>
                                )}
                                        ...
                                        isEditing ? (
                                            <div>
                                                ...
                                                <div className="relative ">
                                                    ...
                                                    <input defaultValue={date_of_birth} type="date" {...register("birthday")} required name="birthday" className="border-gray-600 text-gray-300 border rounded-md bg-[#1A222C]  focus:outline-none focus:border-blue-500 text-sm  block w-full ps-10 py-3 dark:focus:border-blue-500" placeholder="Select your birthday date" />
                                                </div>
                                            </div>
                                        ) :
                                            (
