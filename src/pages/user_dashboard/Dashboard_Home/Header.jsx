...
const Header = () => {
    return (
            ...
            <div>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 p-4 gap-4 bg-gray-100">
                    <div className="bg-white  shadow-lg rounded-md flex items-center justify-between p-3    text-gray-800 font-medium group">
