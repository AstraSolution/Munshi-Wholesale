                                                ...
                                                <td className="border bg-white border-gray-200 p-2 text-sm md:text-md  text-center ">
                                                    ...
                                                    <div className="flex items-center justify-center lg:gap-6 md:gap-4 gap-2  ">
                                                        ...
                                                        <Link to={`/dashboard/update_product/${product?._id}`}>
                                                            <span className="text-xl cursor-pointer "> <CiEdit></CiEdit> </span>
                                                        </Link>


                                                        <span onClick={() => handleDeleteProduct(product?._id, product?.title)} className="text-2xl text-red-600 cursor-pointer "><MdDelete></MdDelete> </span>
                                                    </div>
                                                </td>
                                            </motion.tr>
                                        )
