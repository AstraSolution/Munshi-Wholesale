                ...
                <table className="w-full table-auto shadow-md rounded-md overflow-hidden border border-gray-500">
                    ...
                    <tbody>
                        {wishlistItems?.map((item, i) => (
                            <tr key={i} className="border-b border-gray-500 hover:bg-gray-100">
                                <td className="py-4 px-6 text-center whitespace-nowrap border border-gray-500 text-2xl text-red-600 ">x</td>
                                <td className="py-4 px-6 text-left whitespace-nowrap border border-gray-500">
                                    <img src={item?.image} alt="" className="h-20 w-20 mx-auto rounded-md" />
                                </td>
                                <td className="py-4 px-6 text-left whitespace-nowrap border border-gray-500">
                                    {item?.name}
                                </td>
